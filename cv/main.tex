...
\section{Awards \& Honors}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Top 20 in \href{https://ht-hackathon.tw/tw/}{HOTAI MaaS Hackathon}} 
      {2024 -- Present} 
      {AI Intelligent Travel Checkup}{\textit{(Semi-final ongoing)}}
        ...
        \resumeItemListEnd
    \resumeSubheading
      {Top 30 in \href{https://tw-linefresh.landpress.line.me/}{LINE FRESH Campus Competition}} 
      {2024 -- Present}
      {AI Dementia Medical Care Platform}{\textit{(Semi-final ongoing)}}
        \resumeItemListStart
