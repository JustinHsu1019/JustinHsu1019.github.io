...
%-----------PUBLICATIONS-----------
\section{Publications\textsuperscript{\dag}}
\vspace{1pt}
\resumeSubHeadingListStart
  \resumeSubheading
    {\normalfont{}}{}{}{}
    ...
    {[1] \textbf{Hsin-Ling Hsu} (first author), Ping-Sheng Lin, Jing-Di Lin, and Jengnan Tzeng. \textit{"KAP: MLLM-assisted OCR Text Enhancement for Hybrid Retrieval in Chinese Non-Narrative Documents."} Peer-reviewed research paper accepted to the AI CUP Workshop @ NTCIR-18, to appear in Proceedings of \href{https://research.nii.ac.jp/ntcir/ntcir-18/conference.html}{the 18th \textbf{NTCIR} Conference} (indexed by DBLP), Tokyo, Japan, 2025.}\hspace{0.2cm}\href{https://arxiv.org/pdf/2503.08452}{\textit{(paper link)}}\hspace{0.3cm}\href{https://github.com/JustinHsu1019/KAP}{\textit{(GitHub link)}}

    \vspace{5pt}

    {[2] \textbf{Hsin-Ling Hsu*} (first author), Cong-Tinh Dao*, Luning Wang, Zitao Shuai, Thao Nguyen Minh Phan, Jun-En Ding, Chun-Chieh Liao, Pengfei Hu, Xiaoxue Han, Chih-Ho Hsu, Dongsheng Luo, Wen-Chih Peng, Feng Liu, Fang-Ming Hung, and Chenwei Wu. \textit{"MedPlan: A Two-Stage RAG-Based System for Personalized Medical Plan Generation."} 
        Accepted to \href{https://2025.aclweb.org/calls/industry_track/}{\textbf{ACL} 2025 Industry Track} (\textasciitilde25.1\% acceptance rate, Avg. Rating: 7.00 [6–8]), Vienna, Austria, 2025.}\hspace{0.2cm}\href{https://arxiv.org/pdf/2503.17900}{\textit{(paper link)}}

    \bigskip
    \small{\textit{* Equal contribution.}}

    \small{\textit{\textsuperscript{\dag} All listed publications are peer-reviewed and presented at international conferences.}}
...
\resumeSubHeadingListStart
  \resumeSubheading
    ...
    {[3] \textbf{Hsin-Ling Hsu} (first author) and Jengnan Tzeng. \textit{"DAT: Dynamic Alpha Tuning for Hybrid Retrieval in Retrieval-Augmented Generation."} 
        Under Review at \href{https://colmweb.org/cfp.html}{the 2nd Conference on Language Modeling (\textbf{COLM})}, Montreal, Canada, 2025.}\hspace{0.2cm}\href{https://arxiv.org/pdf/2503.23013}{\textit{(paper link)}}
  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Advisor: \href{https://www.nycu.edu.tw/ihha/en/app/artwebsite/view?module=artwebsite&id=20140&serno=3a7aa8cd-d3bd-4186-9cea-6cbfc9c58bd6}{Dr. Fang-Ming Hung}}
         \resumeItem{[2] Research focuses on developing and training models for disease prediction, medical plan generation, and brain activation and epileptogenic zone prediction using LLMs, CLIP, CNN, Knowledge Graph, information retrieval techniques. These models leverage electronic health records (EHR) from outpatient, inpatient, and emergency departments, along with examination reports and SOAP notes.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Researched cutting-edge AI developments and conducted internal presentations on topics such as LLM Agents architecture principles and their potential business applications, enhancing the company's AI strategic roadmap.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Affiliated with \href{https://homepage.iis.sinica.edu.tw/pages/tirongwu/index_en.html}{Prof. Ti-Rong Wu}'s \href{https://github.com/rlglab/}{Reinforcement Learning and Games Lab}, supporting the research project \href{https://www.iis.sinica.edu.tw/zh/page/ResearchOverview/KeyProjects/DeepReinforcementLearning.html}{\textit{General Computer Game Solving based on Proof Cost Network (PCN)}} through system development.}
        \resumeItem{Responsible for designing and developing both frontend and backend components of computer games (e.g., Go, Kill-All Go, and other board size variants) using WGo.js, C/C++.}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{AI Engineer | Core R\&D Contributor to Open-Source LLM and Whisper Projects at ChainSea, specializing in real-time transcription, inference acceleration, dataset generation and augmentation (e.g., Taipower project under Selected Projects), and model training with expertise in fine-tuning and LoRA techniques.}
        ...
        \resumeItem{Technologies utilized: Python, SentenceTransformer, TensorFlow, PyTorch, Unsloth.}
      \resumeItemListEnd
...
\section{Awards \& Honors}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {AI Intelligent Travel Checkup.
        ...
        \resumeItemListStart
          ...
          \resumeItem{Tech stack: Vue.js, LLM with Hybrid Retreival and Cross-Encoder for intelligent POI suggestions, multi-platform review analysis, and personalized activity recommendations using collaborative filtering.}
        \resumeItemListEnd
    \vspace{0.3em}
    ...
    \resumeSubheading
      {2nd Place in \href{https://iaic.nccu.edu.tw/contests/ai-2024}{AI Interdisciplinary Sustainability Innovation Competition}\normalfont{, [2/44 teams; \textasciitilde4\%]}}
      {2024}
      {Campus AI assistant AllPass Project Lead. 
        ...
        \resumeItemListStart
          \resumeItem{A competition hosted by National Chengchi University (NCCU).}
          \resumeItem{For more details, please refer to the Selected Projects section below.}
        \resumeItemListEnd
    \vspace{0.3em}
  \resumeSubHeadingListEnd
