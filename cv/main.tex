...
\section{Education}
  \resumeSubHeadingListStart
      ...
      \vspace{0.3em}
        ...
        \resumeItem{\textbf{Technical Courses:} Calculus, Linear Algebra, Statistics(I), Machine Learning, Operations Research/Management Science, Computer Programming, Data Structure, Database Management Systems, Introduction to Computer Science, Introduction to Data Analysis and Programming, Python for Data Analysis 101}
        \resumeItem{\textbf{Interdisciplinary Courses:} The Brain and I, AI and Society, An Introduction to Game Theory (I)}
      \resumeItemListEnd
