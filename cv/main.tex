...
\section{Awards \& Honors}
  \resumeSubHeadingListStart
    ...
    \vspace{0.3em}
    \resumeSubheading
      {Top 10 in \href{https://tw-linefresh.landpress.line.me/}{National LINE FRESH Campus Competition}} 
      {2024 -- Present}
      {AI Dementia Medical Care Platform}{\textit{(Final ongoing)}}
        \resumeItemListStart
          \resumeItem{Led system architecture design, AI \& backend development}
        \resumeItemListEnd
    \resumeSubheading
      {Top 10 in \href{https://ht-hackathon.tw/tw/}{National HOTAI MaaS Hackathon}} 
      {2024 -- Present}
      {AI Intelligent Travel Checkup}{\textit{(Final ongoing)}}
        \resumeItemListStart
