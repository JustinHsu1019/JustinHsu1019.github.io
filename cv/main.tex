...
%-----------TEACHING \& TECHNICAL CONTRIBUTIONS-----------
\section{Teaching \& Technical Contributions}
  \resumeSubHeadingListStart
    \resumeSubheading
    {Lecturer}{Sept. 2023 -- Aug. 2024}
    {\href{https://developers.google.com/community/gdg}{Google Developer Group (GDG)} - NCCU}{Taipei, Taiwan}
    \resumeItemListStart
      \resumeItem{Teaching Experience: Generative AI, Introduction to Databases (Course satisfaction rate as high as \textbf{90\%})}
    \resumeItemListEnd
